...
async function main() {
  ...
  const initialQuestions: Array<{
    ...
    {
      key: 'occupants_count',
      label: 'How many people currently live in the apartment',
      helperText: 'Total tenants in the whole unit, including other rooms.',
      type: 'number',
      position: 10,
    },
    {
      key: 'nationalities',
      label: 'Nationalities of the current tenants',
      helperText: 'Free text. e.g. "Filipino, Indian, Egyptian".',
      type: 'text',
      position: 20,
    },
    {
    ...
    },
    {
      ...
      label: 'If shared, with how many people / rooms?',
      helperText: 'Leave blank if private.',
      type: 'text',
      position: 40,
    },
    {
